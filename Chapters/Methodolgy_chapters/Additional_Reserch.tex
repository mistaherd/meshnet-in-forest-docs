This section will discuss any extra research done on the project.
...
\begin{enumerate}
    \item Pi
    \item USB to Windows desktop In this configuration we  can test a single node from our laptop this is just to  test sending messages across the serial 
\end{enumerate}
